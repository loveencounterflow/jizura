(function() {
  ...
  app.command("repetitions").description("find repeated components in formulas or lineups").option("--formulas", "look in formulas").option("--lineups", "look in lineups").action(function(options) {
    var S, SRF, command, formulas, lineups, ref, ref1, source;
    ...
    source = lineups ? 'lineups' : 'formulas';
    S = {
      command: command,
      source: source
    };
