        ...
        if (end != null) {
          for (factor in glyphs_by_factors) {
            ...
            glyphs.forEach(function(glyph) {
              return send([factor, 'factor/has/glyph/uchr', glyph]);
            });
          }
          return end();
        }
