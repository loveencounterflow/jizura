(function() {
  ...
  this.write_mkts_settings = function(layout_info, handler) {
    return step((function(_this) {
      return function*(resume) {
        ...
        lines.push("% generated from " + _this.options['locator']);
        lines.push("");
  ...
  this.pdf_from_md = function(source_route, handler) {
    return step((function(_this) {
      return function*(resume) {
        ...
        HELPERS.provide_tmp_folder(_this.options);
        if (handler == null) {
          handler = function() {};
        }
        layout_info = HELPERS.new_layout_info(_this.options, source_route);
        (yield _this.write_mkts_settings(layout_info, resume));
  ...
  this.$insert_preamble = function(S) {
    var layout_info, settings_locator_bare;
    layout_info = S.layout_info;
