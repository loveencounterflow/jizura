(function() {
  ...
  this.MKTX.REGION.$multi_column = (function(_this) {
    return function(S) {
      var ref1, track, within;
      ref1 = TYPO.new_area_observer('multi-column'), track = ref1[0], within = ref1[1];
      return $(function(event, send) {
  ...
  this.MKTX.REGION.$keep_lines = (function(_this) {
    return function(S) {
      var ref1, track, within;
      ref1 = TYPO.new_area_observer('keep-lines'), track = ref1[0], within = ref1[1];
      return $(function(event, send) {
        ...
        if (TYPO.isa(event, '.', 'text')) {
          ...
          type = event[0], name = event[1], text = event[2], meta = event[3];
          if (type === '{') {
            within('keep-lines', true);
            return send(['tex', "\\begingroup\\obeyalllines{}"]);
          } else {
            send(['tex', "\\endgroup{}"]);
            return within('keep-lines', false);
          }
        } else {
          return send(event);
        }
  ...
  this.MKTX.REGION.$code = (function(_this) {
    return function(S) {
      ...
      var ref1, track, within;
      ref1 = TYPO.new_area_observer('{code}'), track = ref1[0], within = ref1[1];
      return $(function(event, send) {
  ...
  this.MKTX.BLOCK.$heading = (function(_this) {
    return function(S) {
      var ref1, restart_multicols, track, within;
  ...
  this.MKTX.BLOCK.$paragraph = (function(_this) {
    return function(S) {
      ...
      var ref1, ref2, track_1, track_2, within_1, within_2;
      ref1 = TYPO.new_area_observer('{code}'), track_1 = ref1[0], within_1 = ref1[1];
      ref2 = TYPO.new_area_observer('keep-lines'), track_2 = ref2[0], within_2 = ref2[1];
      return $(function(event, send) {
