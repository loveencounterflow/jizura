            ...
            if (is_command) {
              ...
              if ((left_fence != null) && (right_fence != null)) {
                ...
                if (prefix_pattern.test(command_name)) {
                  ...
                  send(['?', part, null, _this._copy(meta)]);
                } else {
                ...
                if ((match = command_name.match(prefix_pattern)) != null) {
                  ...
                  switch (prefix) {
                    case ':':
                      send([left_fence, prefix, suffix, _this._copy(meta)]);
                      break;
                    default:
                ...
                if ((match = command_name.match(prefix_pattern)) != null) {
                  ...
                  switch (prefix) {
                    case ':':
                      send([right_fence, prefix, suffix, _this._copy(meta)]);
                      break;
                    default:
                      warn("prefix " + (rpr(prefix)) + " not supported in " + (rpr(part)));
                      send(['?', part, null, _this._copy(meta)]);
                ...
                if (match == null) {
                  ...
                  switch (prefix) {
                    case '!':
                      send(['∆', suffix, null, _this._copy(meta)]);
                      break;
                    default:
                      warn("prefix " + (rpr(prefix)) + " not supported in " + (rpr(part)));
                      send(['?', part, null, _this._copy(meta)]);
