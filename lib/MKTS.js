(function() {
  ...
  this.$_preprocess_XXXX = function(S) {
    ...
    return $((function(_this) {
      return function(event, send) {
        var i, is_command, last_idx, left_fence, len, meta, name, part, ref, ref1, ref2, right_fence, text, type, within_literal;
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            ...
            if (is_command) {
              ...
              if ((left_fence != null) && (right_fence != null)) {
                send([xxxx(part.slice(1, last_idx), _this._copy(meta))]);
              }
            } else {
