(function() {
  ...
  this.XXX_escape_raw_spans = function(text) {
    var R;
    R = text;
    ...
    R = R.replace(this.XXX_command_pattern, (function(_this) {
      return function(_, $1, $2, $3) {
        ...
        id = _this.XXX_raw_id_from_content('comment', raw_content);
        return $1 + "\x14" + id + "\x13";
      };
    })(this));
  ...
  this.create_mdreadstream = function(md_source, settings) {
    ...
    confluence.pipe(this.$_flatten_tokens(state)).pipe(this.$_reinject_html_blocks(state)).pipe(this.$_rewrite_markdownit_tokens(state)).pipe(this.$XXX_expand_commands(state)).pipe(this.$XXX_expand_raw_spans(state)).pipe(this.$_process_end_command(state)).pipe(R);
    R.on('resume', (function(_this) {
      return function() {
        ...
        environment = {};
        md_source = _this.XXX_escape_raw_spans(md_source);
        debug('23.3194', _this.XXX_comment_by_ids);
