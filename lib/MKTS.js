(function() {
  ...
  this.is_cjk_rsg = function(rsg, options) {
    return indexOf.call(options['tex']['cjk-rsgs'], rsg) >= 0;
  };

  this.fix_typography_for_tex = function(text, options, send) {
    var R, advance, advance_each_chr, chr, chunk, cjk_interchr_glue, command, fncr, glyph_styles, i, is_latin_whitespace, last_command, last_rsg, last_was_cjk, len, message, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, remark, replacement, rsg, tex_command_by_rsgs, this_is_cjk, uchr;
    if (send == null) {
      send = null;
    }
    ...
    cjk_interchr_glue = (ref5 = (ref6 = options['tex']) != null ? ref6['cjk-interchr-glue'] : void 0) != null ? ref5 : '\ue080';
    last_command = null;
    R = [];
    chunk = [];
    last_rsg = null;
    ...
    for (i = 0, len = ref7.length; i < len; i++) {
      ...
      if ((is_latin_whitespace = chr === '\x20' || chr === '\n' || chr === '\r' || chr === '\t')) {
        ...
        this_is_cjk = this.is_cjk_rsg(rsg, options);
        ...
        if ((command = tex_command_by_rsgs[rsg]) == null) {
          command = (ref9 = tex_command_by_rsgs['fallback']) != null ? ref9 : null;
  ...
  this._PRE.$rewrite_markdownit_tokens = (function(_this) {
    return function(S) {
      var _send, is_first, last_map, remark, send_unknown, unknown_tokens, within_footnote_block;
      unknown_tokens = [];
      is_first = true;
      last_map = [0, 0];
      _send = null;
      ...
      return $(function(token, send, end) {
        var col_nr, extra, id, language_name, line_nr, map, markup, meta, name, position, ref, ref1, ref2, type;
        _send = send;
        if (token != null) {
  ...
  this._ESC.initialize = (function(_this) {
  ...
  this._ESC.html_comment_pattern = /(?:(^|[^\\])<!---->)|(?:(^|[^\\])<!--([\s\S]*?[^\\])-->)/g;


  /* Code duplication */

  this._ESC.do_bracketed_pattern = /(?:(^|[^\\])<<\{do>><<do\}>>)|(?:(^|[^\\])<<\{do>>([\s\S]*?[^\\])<<do\}>>)/g;


  /* Code duplication */

  this._ESC.raw_bracketed_pattern = /(?:(^|[^\\])<<\(raw>><<raw\)>>)|(?:(^|[^\\])<<\(raw>>([\s\S]*?[^\\])<<raw\)>>)/g;

  this._ESC.raw_heredoc_pattern = /(^|[^\\])<<!raw:([^\s>]*)>>(.*?)\2/g;


  /* Code duplication */

  this._ESC.raw_id_pattern = /\x15raw([0-9]+)\x13/g;


  /* Code duplication */

  this._ESC.html_comment_id_pattern = /\x15comment([0-9]+)\x13/g;


  /* Code duplication */

  this._ESC.do_id_pattern = /\x15do([0-9]+)\x13/g;


  /* Code duplication */

  this._ESC.action_id_pattern = /\x15action([0-9]+)\x13/g;

  this._ESC.command_pattern = /(^|[^\\])(<<([!{[(]?)([^\s!{[()\]>}]+?)([)\]}]?)>>)/g;

  this._ESC.escape_html_comments_raw_spans_and_commands = (function(_this) {
    return function(S, text) {
      var R;
      debug('©II6XI', rpr(text));
      R = text;
      R = _this._ESC.escape_escape_chrs(R);
      R = R.replace(_this._ESC.html_comment_pattern, function(_, $1, $2, $3) {
        var key, raw_content;
        if ($1 == null) {
          $1 = '';
        }
        ...
        key = _this._ESC.register_content(S, 'comment', raw_content.trim());
        return $1 + "\x15" + key + "\x13";
      });
      R = R.replace(_this._ESC.do_bracketed_pattern, function(_, $1, $2, $3) {
        var id, raw_content;
        if ($1 == null) {
          $1 = '';
        }
        ...
        id = _this._ESC.register_content(S, 'do', raw_content);
        return $1 + "\x15" + id + "\x13";
      });
      R = R.replace(_this._ESC.raw_bracketed_pattern, function(_, $1, $2, $3) {
        var id, raw_content;
        if ($1 == null) {
          $1 = '';
        }
        ...
        $1 += $2;
        raw_content = $3 != null ? $3 : '';
        id = _this._ESC.register_content(S, 'raw', raw_content);
        return $1 + "\x15" + id + "\x13";
      });
      R = R.replace(_this._ESC.raw_heredoc_pattern, function(_, $1, $2, $3) {
        var id, raw_content;
        raw_content = $3 != null ? $3 : '';
        id = _this._ESC.register_content(S, 'raw', raw_content);
        return $1 + "\x15" + id + "\x13";
      });
      R = R.replace(_this._ESC.command_pattern, function(_, $1, $2, $3, $4, $5) {
        var key, parsed_content, raw_content;
        raw_content = $2;
        ...
        key = _this._ESC.register_content(S, 'action', raw_content, parsed_content);
        return $1 + "\x15" + key + "\x13";
      });
      return R;
    };
  ...
  this._ESC.register_content = (function(_this) {
    return function(S, kind, raw, parsed) {
      var entry, id, index, key, registry;
      if (parsed == null) {
        parsed = null;
      }
  ...
  this._ESC.retrieve_entry = (function(_this) {
    return function(S, id) {
      var R;
      if ((R = S['_ESC']['registry'][id]) == null) {
  ...
  this._ESC.$expand_html_comments = (function(_this) {
    return function(S) {
      ...
      return $(function(event, send) {
        ...
        if (_this.select(event, '.', ['text', 'code'])) {
          is_comment = true;
          type = event[0], name = event[1], text = event[2], meta = event[3];
          ref = text.split(_this._ESC.html_comment_id_pattern);
          results = [];
          for (i = 0, len = ref.length; i < len; i++) {
            stretch = ref[i];
            ...
            if (is_comment) {
              ...
              entry = _this._ESC.retrieve_entry(S, id);
              content = entry['raw'];
              results.push(send(['.', 'comment', content, _this.copy(meta)]));
            } else {
              if (stretch.length !== 0) {
  ...
  this._ESC.$expand_actions = (function(_this) {
    return function(S) {

      /* TAINT code duplication */
      var track;
      track = _this.TRACKER.new_tracker('(code)', '{code}');
      return $(function(event, send) {
        ...
        if (_this.select(event, '.', ['text', 'code', 'comment'])) {
          is_command = true;
          type = event[0], name = event[1], text = event[2], meta = event[3];
          ref = text.split(_this._ESC.action_id_pattern);
          results = [];
          for (i = 0, len = ref.length; i < len; i++) {
            stretch = ref[i];
            ...
            if (is_command) {
              ...
              if (within_code) {
                content = entry['raw'];
                results.push(send(['.', 'text', content, _this.copy(meta)]));
              } else {
                ...
                results.push(send([fence, action_name, null, _this.copy(meta)]));
              }
            } else {
              if (stretch.length !== 0) {
                results.push(send([type, name, stretch, _this.copy(meta)]));
  ...
  this._ESC.$expand_raw_spans = (function(_this) {
    return function(S) {
      ...
      return $(function(event, send) {
        ...
        if (_this.select(event, '.', ['text', 'code', 'comment'])) {
          is_raw = true;
          type = event[0], name = event[1], text = event[2], meta = event[3];
          ref = text.split(_this._ESC.raw_id_pattern);
          results = [];
          for (i = 0, len = ref.length; i < len; i++) {
            stretch = ref[i];
            is_raw = !is_raw;
  ...
  this._ESC.$expand_do_spans = (function(_this) {
    return function(S) {
      ...
      return $(function(event, send) {
        ...
        if (_this.select(event, '.', ['text', 'code', 'comment'])) {
          is_do = true;
          type = event[0], name = event[1], text = event[2], meta = event[3];
          ref = text.split(_this._ESC.do_id_pattern);
          results = [];
          for (i = 0, len = ref.length; i < len; i++) {
            stretch = ref[i];
            is_do = !is_do;
            if (is_do) {
              ...
              entry = _this._ESC.retrieve_entry(S, id);
              content = entry['raw'];
              results.push(send(['!', 'do', content, _this.copy(meta)]));
            } else {
              results.push(send([type, name, stretch, _this.copy(meta)]));
            }
          }
  ...
  this._ESC.escape_escape_chrs = (function(_this) {
  ...
  this._ESC.unescape_escape_chrs = (function(_this) {
    return function(text) {
      var R;
      R = text;
  ...
  this.new_resender = function(S, stream) {
    ...
    return (function(_this) {
      return function(md_source) {
        ...
        var environment, first_idx, i, idx, j, keys, last_idx, ref, ref1, ref2, ref3, results, tokens;
        if (CND.isa_text(md_source)) {
          md_source = _this._ESC.escape_html_comments_raw_spans_and_commands(S, md_source);
          environment = {};
          ...
          if (tokens.length > 0) {
            ...
            for (idx = i = ref = first_idx, ref1 = last_idx; ref <= ref1 ? i <= ref1 : i >= ref1; idx = ref <= ref1 ? ++i : --i) {
              debug('©9fdeD', "resending", tokens[idx]);
            }
            results = [];
            for (idx = j = ref2 = first_idx, ref3 = last_idx; ref2 <= ref3 ? j <= ref3 : j >= ref3; idx = ref2 <= ref3 ? ++j : --j) {
  ...
  this.create_mdreadstream = function(md_source, settings) {
    ...
    R.XXX_resend = this.new_resender(S, confluence);
    confluence.pipe(this._PRE.$flatten_tokens(S)).pipe(this._PRE.$reinject_html_blocks(S)).pipe(this._PRE.$rewrite_markdownit_tokens(S)).pipe(this._ESC.$expand_html_comments(S)).pipe(this._ESC.$expand_actions(S)).pipe(this._ESC.$expand_raw_spans(S)).pipe(this._ESC.$expand_do_spans(S)).pipe(this._PRE.$process_end_command(S)).pipe(this._PRE.$consolidate_footnotes(S)).pipe(R);
