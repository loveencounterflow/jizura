(function() {
  ...
  this._PRE.$rewrite_markdownit_tokens = (function(_this) {
    return function(S) {
      ...
      return $(function(token, send, end) {
        var col_nr, extra, language_name, line_nr, map, markup, meta, name, position, ref, ref1, ref2, type;
        _send = send;
        if (token != null) {
  ...
  this._ESC.escape_html_comments_raw_spans_and_commands = (function(_this) {
    return function(state, text) {
      ...
      R = R.replace(_this._ESC.html_comment_pattern, function(_, $1, $2, $3) {
        ...
        key = _this._ESC.register_content(state, 'comment', raw_content.trim());
      ...
      R = R.replace(_this._ESC.do_bracketed_pattern, function(_, $1, $2, $3) {
        ...
        id = _this._ESC.register_content(state, 'do', raw_content);
        return $1 + "\x15" + id + "\x13";
      });
      R = R.replace(_this._ESC.raw_bracketed_pattern, function(_, $1, $2, $3) {
        ...
        $1 += $2;
        raw_content = $3 != null ? $3 : '';
        id = _this._ESC.register_content(state, 'raw', raw_content);
        return $1 + "\x15" + id + "\x13";
      });
      ...
      R = R.replace(_this._ESC.command_pattern, function(_, $1, $2, $3, $4, $5) {
        ...
        key = _this._ESC.register_content(state, 'action', raw_content, parsed_content);
        return $1 + "\x15" + key + "\x13";
      });
      return R;
    };
  ...
  this._ESC.register_content = (function(_this) {
    return function(state, kind, raw, parsed) {
  ...
  this._ESC.retrieve_entry = (function(_this) {
    return function(state, id) {
      var R;
      if ((R = state['_ESC']['registry'][id]) == null) {
        ...
        if (_this.select(event, '.', ['text', 'code'])) {
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            ...
            if (is_comment) {
              ...
              entry = _this._ESC.retrieve_entry(state, id);
              content = entry['raw'];
  ...
  this.new_resender = function(state, stream) {
    var md_parser;
    ...
    return (function(_this) {
      return function(md_source) {
        ...
        var environment, first_idx, i, idx, last_idx, ref, ref1, results, tokens;
        environment = {};
        md_source = _this._ESC.escape_html_comments_raw_spans_and_commands(state, md_source);
  ...
  this.create_mdreadstream = function(md_source, settings) {
    ...
    R.XXX_resend = this.new_resender(state, confluence);
    confluence.pipe(this._PRE.$flatten_tokens(state)).pipe(this._PRE.$reinject_html_blocks(state)).pipe(this._PRE.$rewrite_markdownit_tokens(state)).pipe(this._ESC.$expand_html_comments(state)).pipe(this._ESC.$expand_actions(state)).pipe(this._ESC.$expand_raw_spans(state)).pipe(this._ESC.$expand_do_spans(state)).pipe(this._PRE.$process_end_command(state)).pipe(R);
