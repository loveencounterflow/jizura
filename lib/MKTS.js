(function() {
  ...
  this.fix_typography_for_tex = function(text, options, send) {
    var R, advance, advance_each_chr, chr, command, fncr, glyph_styles, i, last_command, last_rsg, len, message, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, remark, replacement, rsg, stretch, tex_command_by_rsgs, uchr;
    if (send == null) {
      send = null;
    }
    ...
    for (i = 0, len = ref5.length; i < len; i++) {
      ...
      if (chr === '\x20' || chr === '\n' || chr === '\r' || chr === '\t') {
        ...
        if ((command = tex_command_by_rsgs[rsg]) == null) {
          command = (ref7 = tex_command_by_rsgs['fallback']) != null ? ref7 : null;
