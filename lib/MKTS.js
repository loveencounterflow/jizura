(function() {
  ...
  this.fix_typography_for_tex = function(text, options, send) {
    var R, advance, chr, chr_info, command, fncr, glyph_styles, i, last_command, last_rsg, len, message, ref, ref1, ref2, ref3, ref4, remark, replacement, rsg, stretch, tex_command_by_rsgs, uchr;
    if (send == null) {
      send = null;
    }
    ...
    for (i = 0, len = ref3.length; i < len; i++) {
      ...
      if ((command = tex_command_by_rsgs[rsg]) == null) {
        command = (ref4 = tex_command_by_rsgs['fallback']) != null ? ref4 : null;
