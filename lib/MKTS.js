(function() {
  ...
  this._ESC.$expand_actions = (function(_this) {
    return function(state) {
      ...
      /* TAINT code duplication */
      return $(function(event, send) {
        var action_name, content, entry, fence, i, id, is_command, left_fence, len, meta, name, ref, results, right_fence, stretch, text, type;
  ...
  this.new_resender = function(state, stream) {
    ...
    return (function(_this) {
      return function(md_source) {
        ...
        var environment, i, len, results, token, tokens;
        environment = {};
        ...
        for (i = 0, len = tokens.length; i < len; i++) {
          token = tokens[i];
          results.push(stream.write(token));
        }
        return results;
      };
    })(this);
