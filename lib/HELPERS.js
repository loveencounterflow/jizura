(function() {
  ...
  this.new_layout_info = function(options, source_route) {
    var R, aux_locator, content_locator, content_name, job_name, master_ext, master_locator, master_name, pdf_locator, source_home, source_locator, source_name, tex_inputs_home, xelatex_command;
  ...
  this.write_pdf = function(layout_info, handler) {
    var aux_locator, count, digest, job_name, last_digest, master_locator, parameters, pdf_from_tex, pdf_locator, source_home, xelatex_command;
