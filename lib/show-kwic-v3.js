...
(function() {
  ...
  this.show_kwic_v3 = function(db) {
    return step((function(_this) {
      return function*(resume) {
        var $_XXX_sort, $align_affixes_with_braces, $align_affixes_with_spaces, $count_glyphs_etc, $count_lineup_lengths, $exclude_gaiji, $include_sample, $insert_hr, $insert_many_keeplines, $insert_single_keepline, $reorder_phrase, $show, $transform_v3, db_route, factor_sample, glyph_sample, include, input_v3, prefix_max_length, query_v3, ranks, suffix_max_length, window_width;
        db_route = join(__dirname, '../../jizura-datasources/data/leveldb-v2');
        if (db == null) {
          db = HOLLERITH.new_db(db_route, {
            create: false
        ...
        $align_affixes_with_braces = function() {
        ...
        $align_affixes_with_spaces = function() {
          return $(function(event, send) {
            var _, glyph, infix, prefix, prefix_delta, prefix_excess, prefix_excess_max_length, prefix_is_shortened, prefix_length, prefix_padding, sortcode, suffix, suffix_delta, suffix_excess, suffix_excess_max_length, suffix_is_shortened, suffix_length, suffix_padding;
            if (CND.isa_list(event)) {
              glyph = event[0], sortcode = event[1];
        ...
        $transform_v3 = function() {
          return D.combine([$reorder_phrase(), $exclude_gaiji(), $include_sample(), $count_lineup_lengths(), $_XXX_sort(), $insert_single_keepline(), $align_affixes_with_spaces(), $count_glyphs_etc(), $show()]);
        };
        query_v3 = {
