(function() {
  ...
  this.show_kwic_v3 = function(db) {
    return step((function(_this) {
      return function*(resume) {
        var $align_affixes, $count_glyphs_etc, $count_lineup_lengths, $exclude_gaiji, $include_sample, $insert_hr, $reorder_phrase, $show, $transform_v3, db_route, factor_sample, glyph_sample, include, input_v3, lineup_left_count, lineup_right_count, query_v3, ranks;
        db_route = join(__dirname, '../../jizura-datasources/data/leveldb-v2');
        if (db == null) {
          db = HOLLERITH.new_db(db_route, {
            create: false
        ...
        $transform_v3 = function() {
          return D.combine([$reorder_phrase(), $exclude_gaiji(), $include_sample(), $count_lineup_lengths(), $count_glyphs_etc(), $show()]);
        };
        query_v3 = {
