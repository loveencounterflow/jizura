...
(function() {
  ...
  this.describe_glyphs = function(S) {
    ...
    if ((S.factor_sample != null) && (factors = Object.keys(S.factor_sample)).length > 0) {
  ...
  $write_glyphs = (function(_this) {
    return function(S) {
      var empty_prefix, is_first, last_infix, line_count, output;
      ...
      return D.$observe(function(event, has_ended) {
        ...
        if (event != null) {
          if (CND.isa_list(event)) {
            ...
            glyph = event[0], prefix = event[1], infix = event[2], suffix = event[3];
            if ((infix !== last_infix) && (glyph !== infix)) {
