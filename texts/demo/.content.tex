...
\begin{multicols}{2}\mktsErrorbox{unhandled event: [ '?', 'footnote\_ref', '', \{ line\_nr: 27, col\_nr: 28 \} ]}h2\textasciicircum{}\mktsShowpar\par
\end{multicols}
...
helo {\mktsStyleItalic{}world} and {\mktsStyleBold{}everyone}A paragraph with {\mktsStyleItalic{}{\mktsStyleBold{}some}} HTML in it.\mktsShowpar\par
Here’s MD with {\mktsStyleItalic{}single} and {\mktsStyleBold{}double} stars.\mktsShowpar\par
Testing {\mktsStyleItalic{}italics with Chinese: \cn{義大利體}} and {\mktsStyleBold{}bold with Chinese: \cn{黑體}, \ka{ゴシック}\cn{体}}\end{multicols}
\chapter{Regions
}
...
yadda yadda yadda yadda yadda yadda yadda yadda yadda yadda
yadda yadda yadda yadda yadda yadda yadda yadda yadda yadda\mktsShowpar\par
\mktsErrorbox{unhandled event: [ '?', 'footnote\_block\_open', '', \{ line\_nr: 378, col\_nr: 385 \} ]}\mktsErrorbox{unhandled event: [ '?', 'footnote\_open', '', \{ line\_nr: 378, col\_nr: 385 \} ]}h2\textasciicircum{}MKTS Regions \cn{中國皇帝}\textasciicircum{}\mktsErrorbox{unhandled event: [ '?', 'footnote\_anchor', '', \{ line\_nr: 378, col\_nr: 385 \} ]}\mktsErrorbox{unhandled event: [ '?', 'footnote\_close', '', \{ line\_nr: 378, col\_nr: 385 \} ]}\mktsErrorbox{unhandled event: [ '?', 'footnote\_block\_close', '', \{ line\_nr: 378, col\_nr: 385 \} ]}\end{multicols}
% end of MD document
